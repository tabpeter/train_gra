...
# TODO: pick up here! 
phen1 <- bind_rows(
  red |> filter(phen == "phenotype1"),
  green |> filter(phen == "phenotype1"),
  yellow |> filter(phen == "phenotype1")
) |> 
...
phen2 <- bind_rows(
  red |> filter(phen == "phenotype2"),
  green |> filter(phen == "phenotype2")
) |> 
  ...
  right_join(raw_id, by = "row") |> 
  select(c("character", "phenotype2"))


phen3 <- bind_rows(
  red |> filter(phen == "phenotype3"),
  green |> filter(phen == "phenotype3")
) |> 
